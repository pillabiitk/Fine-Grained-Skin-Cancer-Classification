...
x_train, x_test, y_train, y_test = train_test_split(X, Y_cat, test_size=0.20, random_state=1)
x_training, x_validation, y_training, y_validation = train_test_split(x_train, y_train, test_size=0.20, random_state=1)
...
# checkpoint = ModelCheckpoint("/home/stud1/Nitish/Ppaer_2/saved_Model/saved_model_1/finegrained_modelling_3_track_loss.hdf5", monitor='loss', verbose=1,
...
# import os.path
# if os.path.isfile('/home/stud1/Nitish/Ppaer_2/saved_Model/saved_model_1/finegrained_modelling_3_track_loss_1.hdf5') is False:
#     fun_model.save('/home/stud1/Nitish/Ppaer_2/saved_Model/saved_model_1/finegrained_modelling_3_track_loss_1.hdf5')
# ------------------------------------------------LOADING THE SAVED MODEL-----------------------------------------------------------------+
from tensorflow.keras.models import load_model
fun_model=load_model('/home/stud1/Nitish/Ppaer_2/saved_Model/saved_model_1/finegrained_vgg_track_loss.hdf5')
